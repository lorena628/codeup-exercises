...
$rectangle = new Rectangle(10, 3);
echo "area of a rectangle 10 X 3 = " . $rectangle->area() . PHP_EOL;
echo "perimeter of a rectangle 10 X 3 = " . $rectangle->perimeter() . PHP_EOL;



$square = new Square(2, 0);
echo "perimeter of a square with side of 2 is = " . $square->perimeter() . PHP_EOL;
echo "area of a square with side of 2 is = " . $square->area() . PHP_EOL;
